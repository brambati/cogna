...
CREATE TABLE tasks (
    ...
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE,
    FOREIGN KEY (category_id) REFERENCES task_categories(id) ON DELETE
    SET
        NULL,
        INDEX idx_user_id (user_id),
...
INSERT INTO
    task_categories (name, description, color, user_id)
VALUES
...
VALUES
    (
        ...
        'Configurar Docker, Nginx e certificados SSL',
        1,
        2,
        'high',
        'completed',
    ...
    (
        ...
        'Criar interface com jQuery e CSS responsivo',
        1,
        2,
        'medium',
        'pending',
    ...
    (
        'Testes de segurança',
        'Verificar proteções contra XSS, CSRF e SQL Injection',
        1,
        2,
        'high',
        'pending',
    ...
    (
        'Documentação',
        'Escrever README detalhado com instruções',
        1,
        2,
        'medium',
        'pending',
...
DELIMITER / / CREATE TRIGGER update_completed_at BEFORE
UPDATE
    ON tasks FOR EACH ROW BEGIN IF NEW.status = 'completed'
