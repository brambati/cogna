...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if (!empty($validationErrors)) {
            ...
            if (empty($columns)) {
                $pdo->query("ALTER TABLE tasks ADD COLUMN category VARCHAR(50) NULL AFTER description");
            }
            ...
            // Inserir no banco
            $result = $fluent->insertInto('tasks')->values($taskData)->execute();
...
<head>
    ...
    <title>Nova Tarefa - Sistema de Tarefas FluentPDO</title>
